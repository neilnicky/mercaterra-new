...
import { Clock, Heart, MapPin, ShoppingBag, Star, Truck } from "lucide-react";
...
export default function BuyerDashboard({ onAddToCart }: BuyerDashboardProps) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Discover fresh produce from local farmers in your area.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          {stats.map((stat, index) => (
            <div
              key={index}
              className={`${stat.color} p-6 rounded-xl border border-gray-100`}
            >
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-6 rounded-xl">
              ...
              <p className="text-sm text-blue-100 mt-3">
                Perfect weather for fresh deliveries!
              </p>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 p-6 rounded-xl">
              ...
              <p className="text-sm text-green-800">
                January is perfect for citrus fruits and winter vegetables like
                kale and Brussels sprouts. Look for these nutrient-rich options
                in the market!
              </p>
            </div>
          </div>
